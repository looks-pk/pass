    ...
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 border-t gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
      <div className="col-span-full lg:col-span-2">
        <div className="lg:-mt-2 mb-4">
          <Link href="/" className="inline-flex items-center text-black-800 text-xl md:text-2xl font-bold gap-2" aria-label="logo">
            <svg width="95" height="94" viewBox="0 0 95 94" className="w-5 h-auto text-red-500" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div>
        ...
        <nav className="flex flex-col gap-4">
          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Overview</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Solutions</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Pricing</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Customers</a>
          </div>
        </nav>
      </div>
      <div>
        ...
        <nav className="flex flex-col gap-4">
          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">About</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Investor Relations</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Jobs</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Press</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Blog</a>
          </div>
        </nav>
      </div>
      <div>
        ...
        <nav className="flex flex-col gap-4">
          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Contact</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Documentation</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Chat</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">FAQ</a>
          </div>
        </nav>
      </div>
      <div>
        ...
        <nav className="flex flex-col gap-4">
          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Terms of Service</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Privacy Policy</a>
          </div>

          <div>
            <a href="#" className="text-gray-500 hover:text-red-500 active:text-red-600 transition duration-100">Cookie settings</a>
          </div>
        </nav>
      </div>
    </div>
